...
def JILI_order(from_time, to_time):
    order = {
        ...
        "PayoffTime": fake.date_time_between(start_date=from_time, end_date=to_time).isoformat(),
        "PayoffAmount": round(random.uniform(0, 10), 2),
        "Status": random.choice([1, 2, 3]),
        "SettlementTime": fake.date_time_between(start_date=from_time, end_date=to_time).isoformat(),

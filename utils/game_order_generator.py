...
def JILI_order(from_time, to_time):
    order = {
        ...
        "WagersTime": datetime.datetime.strptime(fake.date_time_between(start_date=from_time, end_date=to_time).isoformat(), '%Y-%m-%dT%H:%M:%S').strftime('%Y-%m-%d %H:%M:%S'),
        "BetAmount": round(random.uniform(-10, -1), 2),
        "PayoffTime": datetime.datetime.strptime(fake.date_time_between(start_date=from_time, end_date=to_time).isoformat(), '%Y-%m-%dT%H:%M:%S').strftime('%Y-%m-%d %H:%M:%S'),
        "PayoffAmount": round(random.uniform(0, 10), 2),
        "Status": random.choice([1, 2, 3]),
        "SettlementTime": datetime.datetime.strptime(fake.date_time_between(start_date=from_time, end_date=to_time).isoformat(), '%Y-%m-%dT%H:%M:%S').strftime('%Y-%m-%d %H:%M:%S'),
